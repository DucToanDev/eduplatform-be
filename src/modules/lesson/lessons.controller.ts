...
import { JwtAuthGuard } from '../auth/guards/jwt-auth.guard'; // Đảm bảo đường dẫn này đúng với project của bạn
...
export class LessonsController {
    ...
    @Get('course/:courseId')
    @ApiOperation({ summary: 'Lấy danh sách bài học theo ID khóa học' })
